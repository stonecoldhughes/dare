...
/* Template specialization derived class for testing dgeqrf, rename later */
class matrix_class : public matrix_base<double>
{
    public:
...
matrix_class::matrix_class(int m, int m_add, int n, int n_add)
    :
